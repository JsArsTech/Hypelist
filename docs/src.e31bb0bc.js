    ...
    return function (state) {
      return {
        items: state.items.map(function (item) {
          return id === item.id ? Object.assign({}, item, {
...
var view = function view(state, actions) {
  return (0, _hyperapp.h)("div", null, (0, _hyperapp.h)("h1", null, (0, _hyperapp.h)("strong", null, "Hyper")), (0, _hyperapp.h)(AddItem, {
    add: actions.add,
    input: actions.input,
    value: state.input,
...
var _default = view;
exports.default = _default;
},{"hyperapp":"../node_modules/hyperapp/src/index.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var _state = _interopRequireDefault(require("./js/state.js"));

var _actions = _interopRequireDefault(require("./js/actions.js"));
...
var main = (0, _hyperapp.app)(_state.default, _actions.default, _view.default, document.getElementById('app'));
},{"hyperapp":"../node_modules/hyperapp/src/index.js","./js/state.js":"js/state.js","./js/actions.js":"js/actions.js","./js/view.js":"js/view.js","./index.scss":"index.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "44751" + '/');
